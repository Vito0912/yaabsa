...
@pragma('vm:prefer-inline') @override $Res call({Object? posix = null,Object? directories = null,}) {
  return _then(FilesystemPathsResponse(
...
class _FilesystemPathsResponse implements FilesystemPathsResponse {
  const _FilesystemPathsResponse({@JsonKey(name: 'posix') required this.posix, @JsonKey(name: 'directories')  List<FilesystemDirectory> directories = const <FilesystemDirectory>[]}): _directories = directories;
