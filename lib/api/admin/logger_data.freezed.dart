...
class _LoggerData implements LoggerData {
  const _LoggerData({@JsonKey(name: 'currentDailyLogs', fromJson: _serverLogEntriesFromJson)  List<ServerLogEntry> currentDailyLogs = const <ServerLogEntry>[]}): _currentDailyLogs = currentDailyLogs;
