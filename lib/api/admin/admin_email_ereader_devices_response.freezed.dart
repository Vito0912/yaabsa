...
@pragma('vm:prefer-inline') @override $Res call({Object? ereaderDevices = null,}) {
  return _then(AdminEmailEreaderDevicesResponse(
...
class _AdminEmailEreaderDevicesResponse implements AdminEmailEreaderDevicesResponse {
  const _AdminEmailEreaderDevicesResponse({@JsonKey(name: 'ereaderDevices')  List<AdminEmailEreaderDevice> ereaderDevices = const <AdminEmailEreaderDevice>[]}): _ereaderDevices = ereaderDevices;
