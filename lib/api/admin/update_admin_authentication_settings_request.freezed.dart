...
/// @nodoc
abstract mixin class $UpdateAdminAuthenticationSettingsRequestCopyWith<$Res>  {
  factory $UpdateAdminAuthenticationSettingsRequestCopyWith(UpdateAdminAuthenticationSettingsRequest value, $Res Function(UpdateAdminAuthenticationSettingsRequest) _then) = _$UpdateAdminAuthenticationSettingsRequestCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UpdateAdminAuthenticationSettingsRequestCopyWithImpl<$Res>
    implements $UpdateAdminAuthenticationSettingsRequestCopyWith<$Res> {
  _$UpdateAdminAuthenticationSettingsRequestCopyWithImpl(this._self, this._then);

  final UpdateAdminAuthenticationSettingsRequest _self;
  final $Res Function(UpdateAdminAuthenticationSettingsRequest) _then;

/// Create a copy of UpdateAdminAuthenticationSettingsRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? authLoginCustomMessage = freezed,Object? authActiveAuthMethods = freezed,Object? authOpenIdIssuerUrl = freezed,Object? authOpenIdAuthorizationUrl = freezed,Object? authOpenIdTokenUrl = freezed,Object? authOpenIdUserInfoUrl = freezed,Object? authOpenIdJwksUrl = freezed,Object? authOpenIdLogoutUrl = freezed,Object? authOpenIdClientId = freezed,Object? authOpenIdClientSecret = freezed,Object? authOpenIdTokenSigningAlgorithm = freezed,Object? authOpenIdButtonText = freezed,Object? authOpenIdAutoLaunch = freezed,Object? authOpenIdAutoRegister = freezed,Object? authOpenIdMatchExistingBy = freezed,Object? authOpenIdMobileRedirectUris = freezed,Object? authOpenIdGroupClaim = freezed,Object? authOpenIdAdvancedPermsClaim = freezed,Object? authOpenIdSubfolderForRedirectUrls = freezed,}) {
  return _then(UpdateAdminAuthenticationSettingsRequest(
...
as String?,authActiveAuthMethods: freezed == authActiveAuthMethods ? _self.authActiveAuthMethods : authActiveAuthMethods // ignore: cast_nullable_to_non_nullable
...
as String?,authOpenIdMobileRedirectUris: freezed == authOpenIdMobileRedirectUris ? _self.authOpenIdMobileRedirectUris : authOpenIdMobileRedirectUris // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [UpdateAdminAuthenticationSettingsRequest].
extension UpdateAdminAuthenticationSettingsRequestPatterns on UpdateAdminAuthenticationSettingsRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UpdateAdminAuthenticationSettingsRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UpdateAdminAuthenticationSettingsRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UpdateAdminAuthenticationSettingsRequest value)  $default,){
final _that = this;
switch (_that) {
case _UpdateAdminAuthenticationSettingsRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UpdateAdminAuthenticationSettingsRequest value)?  $default,){
final _that = this;
switch (_that) {
case _UpdateAdminAuthenticationSettingsRequest() when $default != null:
return $default(_that);case _:
...
class _UpdateAdminAuthenticationSettingsRequest implements UpdateAdminAuthenticationSettingsRequest {
  const _UpdateAdminAuthenticationSettingsRequest({@JsonKey(name: 'authLoginCustomMessage') this.authLoginCustomMessage, @JsonKey(name: 'authActiveAuthMethods')  List<String>? authActiveAuthMethods, @JsonKey(name: 'authOpenIDIssuerURL') this.authOpenIdIssuerUrl, @JsonKey(name: 'authOpenIDAuthorizationURL') this.authOpenIdAuthorizationUrl, @JsonKey(name: 'authOpenIDTokenURL') this.authOpenIdTokenUrl, @JsonKey(name: 'authOpenIDUserInfoURL') this.authOpenIdUserInfoUrl, @JsonKey(name: 'authOpenIDJwksURL') this.authOpenIdJwksUrl, @JsonKey(name: 'authOpenIDLogoutURL') this.authOpenIdLogoutUrl, @JsonKey(name: 'authOpenIDClientID') this.authOpenIdClientId, @JsonKey(name: 'authOpenIDClientSecret') this.authOpenIdClientSecret, @JsonKey(name: 'authOpenIDTokenSigningAlgorithm') this.authOpenIdTokenSigningAlgorithm, @JsonKey(name: 'authOpenIDButtonText') this.authOpenIdButtonText, @JsonKey(name: 'authOpenIDAutoLaunch') this.authOpenIdAutoLaunch, @JsonKey(name: 'authOpenIDAutoRegister') this.authOpenIdAutoRegister, @JsonKey(name: 'authOpenIDMatchExistingBy') this.authOpenIdMatchExistingBy, @JsonKey(name: 'authOpenIDMobileRedirectURIs')  List<String>? authOpenIdMobileRedirectUris, @JsonKey(name: 'authOpenIDGroupClaim') this.authOpenIdGroupClaim, @JsonKey(name: 'authOpenIDAdvancedPermsClaim') this.authOpenIdAdvancedPermsClaim, @JsonKey(name: 'authOpenIDSubfolderForRedirectURLs') this.authOpenIdSubfolderForRedirectUrls}): _authActiveAuthMethods = authActiveAuthMethods,_authOpenIdMobileRedirectUris = authOpenIdMobileRedirectUris;
  factory _UpdateAdminAuthenticationSettingsRequest.fromJson(Map<String, dynamic> json) => _$UpdateAdminAuthenticationSettingsRequestFromJson(json);
...
@override@JsonKey(name: 'authOpenIDMobileRedirectURIs') List<String>? get authOpenIdMobileRedirectUris {
  final value = _authOpenIdMobileRedirectUris;
  if (value == null) return null;
...
@pragma('vm:prefer-inline')
_$UpdateAdminAuthenticationSettingsRequestCopyWith<_UpdateAdminAuthenticationSettingsRequest> get copyWith => __$UpdateAdminAuthenticationSettingsRequestCopyWithImpl<_UpdateAdminAuthenticationSettingsRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UpdateAdminAuthenticationSettingsRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateAdminAuthenticationSettingsRequest&&(identical(other.authLoginCustomMessage, authLoginCustomMessage) || other.authLoginCustomMessage == authLoginCustomMessage)&&const DeepCollectionEquality().equals(other._authActiveAuthMethods, _authActiveAuthMethods)&&(identical(other.authOpenIdIssuerUrl, authOpenIdIssuerUrl) || other.authOpenIdIssuerUrl == authOpenIdIssuerUrl)&&(identical(other.authOpenIdAuthorizationUrl, authOpenIdAuthorizationUrl) || other.authOpenIdAuthorizationUrl == authOpenIdAuthorizationUrl)&&(identical(other.authOpenIdTokenUrl, authOpenIdTokenUrl) || other.authOpenIdTokenUrl == authOpenIdTokenUrl)&&(identical(other.authOpenIdUserInfoUrl, authOpenIdUserInfoUrl) || other.authOpenIdUserInfoUrl == authOpenIdUserInfoUrl)&&(identical(other.authOpenIdJwksUrl, authOpenIdJwksUrl) || other.authOpenIdJwksUrl == authOpenIdJwksUrl)&&(identical(other.authOpenIdLogoutUrl, authOpenIdLogoutUrl) || other.authOpenIdLogoutUrl == authOpenIdLogoutUrl)&&(identical(other.authOpenIdClientId, authOpenIdClientId) || other.authOpenIdClientId == authOpenIdClientId)&&(identical(other.authOpenIdClientSecret, authOpenIdClientSecret) || other.authOpenIdClientSecret == authOpenIdClientSecret)&&(identical(other.authOpenIdTokenSigningAlgorithm, authOpenIdTokenSigningAlgorithm) || other.authOpenIdTokenSigningAlgorithm == authOpenIdTokenSigningAlgorithm)&&(identical(other.authOpenIdButtonText, authOpenIdButtonText) || other.authOpenIdButtonText == authOpenIdButtonText)&&(identical(other.authOpenIdAutoLaunch, authOpenIdAutoLaunch) || other.authOpenIdAutoLaunch == authOpenIdAutoLaunch)&&(identical(other.authOpenIdAutoRegister, authOpenIdAutoRegister) || other.authOpenIdAutoRegister == authOpenIdAutoRegister)&&(identical(other.authOpenIdMatchExistingBy, authOpenIdMatchExistingBy) || other.authOpenIdMatchExistingBy == authOpenIdMatchExistingBy)&&const DeepCollectionEquality().equals(other._authOpenIdMobileRedirectUris, _authOpenIdMobileRedirectUris)&&(identical(other.authOpenIdGroupClaim, authOpenIdGroupClaim) || other.authOpenIdGroupClaim == authOpenIdGroupClaim)&&(identical(other.authOpenIdAdvancedPermsClaim, authOpenIdAdvancedPermsClaim) || other.authOpenIdAdvancedPermsClaim == authOpenIdAdvancedPermsClaim)&&(identical(other.authOpenIdSubfolderForRedirectUrls, authOpenIdSubfolderForRedirectUrls) || other.authOpenIdSubfolderForRedirectUrls == authOpenIdSubfolderForRedirectUrls));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,authLoginCustomMessage,const DeepCollectionEquality().hash(_authActiveAuthMethods),authOpenIdIssuerUrl,authOpenIdAuthorizationUrl,authOpenIdTokenUrl,authOpenIdUserInfoUrl,authOpenIdJwksUrl,authOpenIdLogoutUrl,authOpenIdClientId,authOpenIdClientSecret,authOpenIdTokenSigningAlgorithm,authOpenIdButtonText,authOpenIdAutoLaunch,authOpenIdAutoRegister,authOpenIdMatchExistingBy,const DeepCollectionEquality().hash(_authOpenIdMobileRedirectUris),authOpenIdGroupClaim,authOpenIdAdvancedPermsClaim,authOpenIdSubfolderForRedirectUrls]);
...
/// @nodoc
abstract mixin class _$UpdateAdminAuthenticationSettingsRequestCopyWith<$Res> implements $UpdateAdminAuthenticationSettingsRequestCopyWith<$Res> {
  factory _$UpdateAdminAuthenticationSettingsRequestCopyWith(_UpdateAdminAuthenticationSettingsRequest value, $Res Function(_UpdateAdminAuthenticationSettingsRequest) _then) = __$UpdateAdminAuthenticationSettingsRequestCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'authLoginCustomMessage') String? authLoginCustomMessage,@JsonKey(name: 'authActiveAuthMethods') List<String>? authActiveAuthMethods,@JsonKey(name: 'authOpenIDIssuerURL') String? authOpenIdIssuerUrl,@JsonKey(name: 'authOpenIDAuthorizationURL') String? authOpenIdAuthorizationUrl,@JsonKey(name: 'authOpenIDTokenURL') String? authOpenIdTokenUrl,@JsonKey(name: 'authOpenIDUserInfoURL') String? authOpenIdUserInfoUrl,@JsonKey(name: 'authOpenIDJwksURL') String? authOpenIdJwksUrl,@JsonKey(name: 'authOpenIDLogoutURL') String? authOpenIdLogoutUrl,@JsonKey(name: 'authOpenIDClientID') String? authOpenIdClientId,@JsonKey(name: 'authOpenIDClientSecret') String? authOpenIdClientSecret,@JsonKey(name: 'authOpenIDTokenSigningAlgorithm') String? authOpenIdTokenSigningAlgorithm,@JsonKey(name: 'authOpenIDButtonText') String? authOpenIdButtonText,@JsonKey(name: 'authOpenIDAutoLaunch') bool? authOpenIdAutoLaunch,@JsonKey(name: 'authOpenIDAutoRegister') bool? authOpenIdAutoRegister,@JsonKey(name: 'authOpenIDMatchExistingBy') String? authOpenIdMatchExistingBy,@JsonKey(name: 'authOpenIDMobileRedirectURIs') List<String>? authOpenIdMobileRedirectUris,@JsonKey(name: 'authOpenIDGroupClaim') String? authOpenIdGroupClaim,@JsonKey(name: 'authOpenIDAdvancedPermsClaim') String? authOpenIdAdvancedPermsClaim,@JsonKey(name: 'authOpenIDSubfolderForRedirectURLs') String? authOpenIdSubfolderForRedirectUrls
});
...
/// @nodoc
class __$UpdateAdminAuthenticationSettingsRequestCopyWithImpl<$Res>
    implements _$UpdateAdminAuthenticationSettingsRequestCopyWith<$Res> {
  __$UpdateAdminAuthenticationSettingsRequestCopyWithImpl(this._self, this._then);

  final _UpdateAdminAuthenticationSettingsRequest _self;
  final $Res Function(_UpdateAdminAuthenticationSettingsRequest) _then;

/// Create a copy of UpdateAdminAuthenticationSettingsRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? authLoginCustomMessage = freezed,Object? authActiveAuthMethods = freezed,Object? authOpenIdIssuerUrl = freezed,Object? authOpenIdAuthorizationUrl = freezed,Object? authOpenIdTokenUrl = freezed,Object? authOpenIdUserInfoUrl = freezed,Object? authOpenIdJwksUrl = freezed,Object? authOpenIdLogoutUrl = freezed,Object? authOpenIdClientId = freezed,Object? authOpenIdClientSecret = freezed,Object? authOpenIdTokenSigningAlgorithm = freezed,Object? authOpenIdButtonText = freezed,Object? authOpenIdAutoLaunch = freezed,Object? authOpenIdAutoRegister = freezed,Object? authOpenIdMatchExistingBy = freezed,Object? authOpenIdMobileRedirectUris = freezed,Object? authOpenIdGroupClaim = freezed,Object? authOpenIdAdvancedPermsClaim = freezed,Object? authOpenIdSubfolderForRedirectUrls = freezed,}) {
  return _then(_UpdateAdminAuthenticationSettingsRequest(
authLoginCustomMessage: freezed == authLoginCustomMessage ? _self.authLoginCustomMessage : authLoginCustomMessage // ignore: cast_nullable_to_non_nullable
as String?,authActiveAuthMethods: freezed == authActiveAuthMethods ? _self._authActiveAuthMethods : authActiveAuthMethods // ignore: cast_nullable_to_non_nullable
as List<String>?,authOpenIdIssuerUrl: freezed == authOpenIdIssuerUrl ? _self.authOpenIdIssuerUrl : authOpenIdIssuerUrl // ignore: cast_nullable_to_non_nullable
as String?,authOpenIdAuthorizationUrl: freezed == authOpenIdAuthorizationUrl ? _self.authOpenIdAuthorizationUrl : authOpenIdAuthorizationUrl // ignore: cast_nullable_to_non_nullable
as String?,authOpenIdTokenUrl: freezed == authOpenIdTokenUrl ? _self.authOpenIdTokenUrl : authOpenIdTokenUrl // ignore: cast_nullable_to_non_nullable
as String?,authOpenIdUserInfoUrl: freezed == authOpenIdUserInfoUrl ? _self.authOpenIdUserInfoUrl : authOpenIdUserInfoUrl // ignore: cast_nullable_to_non_nullable
...
as bool?,authOpenIdAutoRegister: freezed == authOpenIdAutoRegister ? _self.authOpenIdAutoRegister : authOpenIdAutoRegister // ignore: cast_nullable_to_non_nullable
as bool?,authOpenIdMatchExistingBy: freezed == authOpenIdMatchExistingBy ? _self.authOpenIdMatchExistingBy : authOpenIdMatchExistingBy // ignore: cast_nullable_to_non_nullable
as String?,authOpenIdMobileRedirectUris: freezed == authOpenIdMobileRedirectUris ? _self._authOpenIdMobileRedirectUris : authOpenIdMobileRedirectUris // ignore: cast_nullable_to_non_nullable
as List<String>?,authOpenIdGroupClaim: freezed == authOpenIdGroupClaim ? _self.authOpenIdGroupClaim : authOpenIdGroupClaim // ignore: cast_nullable_to_non_nullable
as String?,authOpenIdAdvancedPermsClaim: freezed == authOpenIdAdvancedPermsClaim ? _self.authOpenIdAdvancedPermsClaim : authOpenIdAdvancedPermsClaim // ignore: cast_nullable_to_non_nullable
as String?,authOpenIdSubfolderForRedirectUrls: freezed == authOpenIdSubfolderForRedirectUrls ? _self.authOpenIdSubfolderForRedirectUrls : authOpenIdSubfolderForRedirectUrls // ignore: cast_nullable_to_non_nullable
as String?,
