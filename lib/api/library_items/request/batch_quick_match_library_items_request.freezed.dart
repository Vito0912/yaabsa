...
@pragma('vm:prefer-inline') @override $Res call({Object? libraryItemIds = null,Object? options = null,}) {
  return _then(BatchQuickMatchLibraryItemsRequest(
...
class _BatchQuickMatchLibraryItemsRequest implements BatchQuickMatchLibraryItemsRequest {
  const _BatchQuickMatchLibraryItemsRequest({@JsonKey(name: 'libraryItemIds') required  List<String> libraryItemIds, @JsonKey(name: 'options') required this.options}): _libraryItemIds = libraryItemIds;
