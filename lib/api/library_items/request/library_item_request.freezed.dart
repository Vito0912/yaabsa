...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? expanded = freezed,Object? include = freezed,Object? episode = freezed,}) {
  return _then(LibraryItemRequest(
...
/// Adds pattern-matching-related methods to [LibraryItemRequest].
extension LibraryItemRequestPatterns on LibraryItemRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LibraryItemRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LibraryItemRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LibraryItemRequest value)  $default,){
final _that = this;
switch (_that) {
case _LibraryItemRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LibraryItemRequest value)?  $default,){
final _that = this;
switch (_that) {
case _LibraryItemRequest() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  String id, @JsonKey(name: "expanded")  int? expanded, @JsonKey(name: "include")  String? include, @JsonKey(name: "episode")  String? episode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LibraryItemRequest() when $default != null:
return $default(_that.id,_that.expanded,_that.include,_that.episode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  String id, @JsonKey(name: "expanded")  int? expanded, @JsonKey(name: "include")  String? include, @JsonKey(name: "episode")  String? episode)  $default,) {final _that = this;
switch (_that) {
case _LibraryItemRequest():
return $default(_that.id,_that.expanded,_that.include,_that.episode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "id")  String id, @JsonKey(name: "expanded")  int? expanded, @JsonKey(name: "include")  String? include, @JsonKey(name: "episode")  String? episode)?  $default,) {final _that = this;
switch (_that) {
case _LibraryItemRequest() when $default != null:
return $default(_that.id,_that.expanded,_that.include,_that.episode);case _:
  return null;
