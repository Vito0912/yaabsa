...
/// Adds pattern-matching-related methods to [PlayLibraryItemRequest].
extension PlayLibraryItemRequestPatterns on PlayLibraryItemRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PlayLibraryItemRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PlayLibraryItemRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PlayLibraryItemRequest value)  $default,){
final _that = this;
switch (_that) {
case _PlayLibraryItemRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PlayLibraryItemRequest value)?  $default,){
final _that = this;
switch (_that) {
case _PlayLibraryItemRequest() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "deviceInfo")  DeviceInfo deviceInfo, @JsonKey(name: "forceDirectPlay")  bool? forceDirectPlay, @JsonKey(name: "forceTranscode")  bool? forceTranscode, @JsonKey(name: "supportedMimeTypes")  List<String>? supportedMimeTypes, @JsonKey(name: "mediaPlayer")  String mediaPlayer)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlayLibraryItemRequest() when $default != null:
return $default(_that.deviceInfo,_that.forceDirectPlay,_that.forceTranscode,_that.supportedMimeTypes,_that.mediaPlayer);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "deviceInfo")  DeviceInfo deviceInfo, @JsonKey(name: "forceDirectPlay")  bool? forceDirectPlay, @JsonKey(name: "forceTranscode")  bool? forceTranscode, @JsonKey(name: "supportedMimeTypes")  List<String>? supportedMimeTypes, @JsonKey(name: "mediaPlayer")  String mediaPlayer)  $default,) {final _that = this;
switch (_that) {
case _PlayLibraryItemRequest():
return $default(_that.deviceInfo,_that.forceDirectPlay,_that.forceTranscode,_that.supportedMimeTypes,_that.mediaPlayer);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "deviceInfo")  DeviceInfo deviceInfo, @JsonKey(name: "forceDirectPlay")  bool? forceDirectPlay, @JsonKey(name: "forceTranscode")  bool? forceTranscode, @JsonKey(name: "supportedMimeTypes")  List<String>? supportedMimeTypes, @JsonKey(name: "mediaPlayer")  String mediaPlayer)?  $default,) {final _that = this;
switch (_that) {
case _PlayLibraryItemRequest() when $default != null:
return $default(_that.deviceInfo,_that.forceDirectPlay,_that.forceTranscode,_that.supportedMimeTypes,_that.mediaPlayer);case _:
  return null;
