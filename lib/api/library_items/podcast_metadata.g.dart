...
_PodcastMetadata _$PodcastMetadataFromJson(Map<String, dynamic> json) => _PodcastMetadata(
...
Map<String, dynamic> _$PodcastMetadataToJson(_PodcastMetadata instance) => <String, dynamic>{
