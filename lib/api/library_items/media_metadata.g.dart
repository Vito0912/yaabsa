...
_MediaMetadata _$MediaMetadataFromJson(Map<String, dynamic> json) => _MediaMetadata(
...
Map<String, dynamic> _$MediaMetadataToJson(_MediaMetadata instance) => <String, dynamic>{
