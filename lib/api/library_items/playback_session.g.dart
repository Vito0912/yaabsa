...
_PlaybackSession _$PlaybackSessionFromJson(Map<String, dynamic> json) => _PlaybackSession(
  ...
  deviceInfo: json['deviceInfo'] == null ? null : DeviceInfo.fromJson(json['deviceInfo'] as Map<String, dynamic>),
...
Map<String, dynamic> _$PlaybackSessionToJson(_PlaybackSession instance) => <String, dynamic>{
  'id': instance.id,
