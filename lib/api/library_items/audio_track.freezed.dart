...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "index")  int? index, @JsonKey(name: "startOffset")  double startOffset, @JsonKey(name: "duration")  double duration, @JsonKey(name: "title")  String title, @JsonKey(name: "contentUrl")  String contentUrl, @JsonKey(name: "mimeType")  String mimeType, @JsonKey(name: "metadata")  LibraryFileMetadata? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AudioTrack() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "index")  int? index, @JsonKey(name: "startOffset")  double startOffset, @JsonKey(name: "duration")  double duration, @JsonKey(name: "title")  String title, @JsonKey(name: "contentUrl")  String contentUrl, @JsonKey(name: "mimeType")  String mimeType, @JsonKey(name: "metadata")  LibraryFileMetadata? metadata)  $default,) {final _that = this;
switch (_that) {
case _AudioTrack():
return $default(_that.index,_that.startOffset,_that.duration,_that.title,_that.contentUrl,_that.mimeType,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "index")  int? index, @JsonKey(name: "startOffset")  double startOffset, @JsonKey(name: "duration")  double duration, @JsonKey(name: "title")  String title, @JsonKey(name: "contentUrl")  String contentUrl, @JsonKey(name: "mimeType")  String mimeType, @JsonKey(name: "metadata")  LibraryFileMetadata? metadata)?  $default,) {final _that = this;
switch (_that) {
case _AudioTrack() when $default != null:
return $default(_that.index,_that.startOffset,_that.duration,_that.title,_that.contentUrl,_that.mimeType,_that.metadata);case _:
  return null;
