...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PodcastMetadata? podcastMetadata,  MediaMetadata? bookMetadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Metadata() when $default != null:
return $default(_that.podcastMetadata,_that.bookMetadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PodcastMetadata? podcastMetadata,  MediaMetadata? bookMetadata)  $default,) {final _that = this;
switch (_that) {
case _Metadata():
return $default(_that.podcastMetadata,_that.bookMetadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PodcastMetadata? podcastMetadata,  MediaMetadata? bookMetadata)?  $default,) {final _that = this;
switch (_that) {
case _Metadata() when $default != null:
return $default(_that.podcastMetadata,_that.bookMetadata);case _:
  return null;
