...
_ServerStatus _$ServerStatusFromJson(Map<String, dynamic> json) => _ServerStatus(
  ...
  authMethods: (json['authMethods'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const <String>[],
...
_AuthFormData _$AuthFormDataFromJson(Map<String, dynamic> json) => _AuthFormData(
...
Map<String, dynamic> _$AuthFormDataToJson(_AuthFormData instance) => <String, dynamic>{
