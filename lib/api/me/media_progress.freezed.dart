...
@JsonKey(name: "id") String get id;@JsonKey(name: "userId") String get userId;@JsonKey(name: "libraryItemId") String get libraryItemId;@JsonKey(name: "episodeId") String? get episodeId;@JsonKey(name: "mediaItemId") String get mediaItemId;@JsonKey(name: "mediaItemType")@MediaItemTypeConverter() MediaItemType get mediaItemType;@AllowNullableForDoubleConverter()@JsonKey(name: "duration") double get duration;@AllowNullableForDoubleConverter()@JsonKey(name: "progress") double get progress;@AllowNullableForDoubleConverter()@JsonKey(name: "currentTime") double get currentTime;@JsonKey(name: "isFinished") bool get isFinished;@JsonKey(name: "hideFromContinueListening") bool? get hideFromContinueListening;@IntToStringConverter()@JsonKey(name: "ebookLocation") String? get ebookLocation;@JsonKey(name: "ebookProgress") double? get ebookProgress;@JsonKey(name: "lastUpdate") int? get lastUpdate;@JsonKey(name: "startedAt") int get startedAt;@JsonKey(name: "finishedAt") int? get finishedAt;
...
@useResult
$Res call({
@JsonKey(name: "id") String id,@JsonKey(name: "userId") String userId,@JsonKey(name: "libraryItemId") String libraryItemId,@JsonKey(name: "episodeId") String? episodeId,@JsonKey(name: "mediaItemId") String mediaItemId,@JsonKey(name: "mediaItemType")@MediaItemTypeConverter() MediaItemType mediaItemType,@AllowNullableForDoubleConverter()@JsonKey(name: "duration") double duration,@AllowNullableForDoubleConverter()@JsonKey(name: "progress") double progress,@AllowNullableForDoubleConverter()@JsonKey(name: "currentTime") double currentTime,@JsonKey(name: "isFinished") bool isFinished,@JsonKey(name: "hideFromContinueListening") bool? hideFromContinueListening,@IntToStringConverter()@JsonKey(name: "ebookLocation") String? ebookLocation,@JsonKey(name: "ebookProgress") double? ebookProgress,@JsonKey(name: "lastUpdate") int? lastUpdate,@JsonKey(name: "startedAt") int startedAt,@JsonKey(name: "finishedAt") int? finishedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  String id, @JsonKey(name: "userId")  String userId, @JsonKey(name: "libraryItemId")  String libraryItemId, @JsonKey(name: "episodeId")  String? episodeId, @JsonKey(name: "mediaItemId")  String mediaItemId, @JsonKey(name: "mediaItemType")@MediaItemTypeConverter()  MediaItemType mediaItemType, @AllowNullableForDoubleConverter()@JsonKey(name: "duration")  double duration, @AllowNullableForDoubleConverter()@JsonKey(name: "progress")  double progress, @AllowNullableForDoubleConverter()@JsonKey(name: "currentTime")  double currentTime, @JsonKey(name: "isFinished")  bool isFinished, @JsonKey(name: "hideFromContinueListening")  bool? hideFromContinueListening, @IntToStringConverter()@JsonKey(name: "ebookLocation")  String? ebookLocation, @JsonKey(name: "ebookProgress")  double? ebookProgress, @JsonKey(name: "lastUpdate")  int? lastUpdate, @JsonKey(name: "startedAt")  int startedAt, @JsonKey(name: "finishedAt")  int? finishedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MediaProgress() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  String id, @JsonKey(name: "userId")  String userId, @JsonKey(name: "libraryItemId")  String libraryItemId, @JsonKey(name: "episodeId")  String? episodeId, @JsonKey(name: "mediaItemId")  String mediaItemId, @JsonKey(name: "mediaItemType")@MediaItemTypeConverter()  MediaItemType mediaItemType, @AllowNullableForDoubleConverter()@JsonKey(name: "duration")  double duration, @AllowNullableForDoubleConverter()@JsonKey(name: "progress")  double progress, @AllowNullableForDoubleConverter()@JsonKey(name: "currentTime")  double currentTime, @JsonKey(name: "isFinished")  bool isFinished, @JsonKey(name: "hideFromContinueListening")  bool? hideFromContinueListening, @IntToStringConverter()@JsonKey(name: "ebookLocation")  String? ebookLocation, @JsonKey(name: "ebookProgress")  double? ebookProgress, @JsonKey(name: "lastUpdate")  int? lastUpdate, @JsonKey(name: "startedAt")  int startedAt, @JsonKey(name: "finishedAt")  int? finishedAt)  $default,) {final _that = this;
switch (_that) {
case _MediaProgress():
return $default(_that.id,_that.userId,_that.libraryItemId,_that.episodeId,_that.mediaItemId,_that.mediaItemType,_that.duration,_that.progress,_that.currentTime,_that.isFinished,_that.hideFromContinueListening,_that.ebookLocation,_that.ebookProgress,_that.lastUpdate,_that.startedAt,_that.finishedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "id")  String id, @JsonKey(name: "userId")  String userId, @JsonKey(name: "libraryItemId")  String libraryItemId, @JsonKey(name: "episodeId")  String? episodeId, @JsonKey(name: "mediaItemId")  String mediaItemId, @JsonKey(name: "mediaItemType")@MediaItemTypeConverter()  MediaItemType mediaItemType, @AllowNullableForDoubleConverter()@JsonKey(name: "duration")  double duration, @AllowNullableForDoubleConverter()@JsonKey(name: "progress")  double progress, @AllowNullableForDoubleConverter()@JsonKey(name: "currentTime")  double currentTime, @JsonKey(name: "isFinished")  bool isFinished, @JsonKey(name: "hideFromContinueListening")  bool? hideFromContinueListening, @IntToStringConverter()@JsonKey(name: "ebookLocation")  String? ebookLocation, @JsonKey(name: "ebookProgress")  double? ebookProgress, @JsonKey(name: "lastUpdate")  int? lastUpdate, @JsonKey(name: "startedAt")  int startedAt, @JsonKey(name: "finishedAt")  int? finishedAt)?  $default,) {final _that = this;
switch (_that) {
case _MediaProgress() when $default != null:
return $default(_that.id,_that.userId,_that.libraryItemId,_that.episodeId,_that.mediaItemId,_that.mediaItemType,_that.duration,_that.progress,_that.currentTime,_that.isFinished,_that.hideFromContinueListening,_that.ebookLocation,_that.ebookProgress,_that.lastUpdate,_that.startedAt,_that.finishedAt);case _:
  return null;
...
class _MediaProgress implements MediaProgress {
  const _MediaProgress({@JsonKey(name: "id") required this.id, @JsonKey(name: "userId") required this.userId, @JsonKey(name: "libraryItemId") required this.libraryItemId, @JsonKey(name: "episodeId") required this.episodeId, @JsonKey(name: "mediaItemId") required this.mediaItemId, @JsonKey(name: "mediaItemType")@MediaItemTypeConverter() required this.mediaItemType, @AllowNullableForDoubleConverter()@JsonKey(name: "duration") required this.duration, @AllowNullableForDoubleConverter()@JsonKey(name: "progress") required this.progress, @AllowNullableForDoubleConverter()@JsonKey(name: "currentTime") required this.currentTime, @JsonKey(name: "isFinished") required this.isFinished, @JsonKey(name: "hideFromContinueListening") this.hideFromContinueListening, @IntToStringConverter()@JsonKey(name: "ebookLocation") this.ebookLocation, @JsonKey(name: "ebookProgress") this.ebookProgress, @JsonKey(name: "lastUpdate") required this.lastUpdate, @JsonKey(name: "startedAt") required this.startedAt, @JsonKey(name: "finishedAt") required this.finishedAt});
...
@override@AllowNullableForDoubleConverter()@JsonKey(name: "duration") final  double duration;
@override@AllowNullableForDoubleConverter()@JsonKey(name: "progress") final  double progress;
@override@AllowNullableForDoubleConverter()@JsonKey(name: "currentTime") final  double currentTime;
...
@override@IntToStringConverter()@JsonKey(name: "ebookLocation") final  String? ebookLocation;
