...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "download")  bool download, @JsonKey(name: "update")  bool update, @JsonKey(name: "delete")  bool delete, @JsonKey(name: "upload")  bool upload, @JsonKey(name: "accessAllLibraries")  bool accessAllLibraries, @JsonKey(name: "accessAllTags")  bool accessAllTags, @JsonKey(name: "accessExplicitContent")  bool accessExplicitContent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Permissions() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "download")  bool download, @JsonKey(name: "update")  bool update, @JsonKey(name: "delete")  bool delete, @JsonKey(name: "upload")  bool upload, @JsonKey(name: "accessAllLibraries")  bool accessAllLibraries, @JsonKey(name: "accessAllTags")  bool accessAllTags, @JsonKey(name: "accessExplicitContent")  bool accessExplicitContent)  $default,) {final _that = this;
switch (_that) {
case _Permissions():
return $default(_that.download,_that.update,_that.delete,_that.upload,_that.accessAllLibraries,_that.accessAllTags,_that.accessExplicitContent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "download")  bool download, @JsonKey(name: "update")  bool update, @JsonKey(name: "delete")  bool delete, @JsonKey(name: "upload")  bool upload, @JsonKey(name: "accessAllLibraries")  bool accessAllLibraries, @JsonKey(name: "accessAllTags")  bool accessAllTags, @JsonKey(name: "accessExplicitContent")  bool accessExplicitContent)?  $default,) {final _that = this;
switch (_that) {
case _Permissions() when $default != null:
return $default(_that.download,_that.update,_that.delete,_that.upload,_that.accessAllLibraries,_that.accessAllTags,_that.accessExplicitContent);case _:
  return null;
