...
_SearchSeries _$SearchSeriesFromJson(Map<String, dynamic> json) => _SearchSeries(
...
Map<String, dynamic> _$SearchSeriesToJson(_SearchSeries instance) => <String, dynamic>{
