...
_SearchLibrary _$SearchLibraryFromJson(Map<String, dynamic> json) => _SearchLibrary(
  book: (json['book'] as List<dynamic>?)?.map((e) => SearchLibraryResult.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  narrators: (json['narrators'] as List<dynamic>?)
      ...
      .toList(),
  tags: (json['tags'] as List<dynamic>?)?.map((e) => SearchResultItem.fromJson(e as Map<String, dynamic>)).toList(),
  genres: (json['genres'] as List<dynamic>?)?.map((e) => SearchResultItem.fromJson(e as Map<String, dynamic>)).toList(),
  series: (json['series'] as List<dynamic>?)?.map((e) => SearchSeries.fromJson(e as Map<String, dynamic>)).toList(),
  authors: (json['authors'] as List<dynamic>?)
      ?.map((e) => SearchLibraryAuthor.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$SearchLibraryToJson(_SearchLibrary instance) => <String, dynamic>{
  'book': instance.book,
...
_SearchLibraryResult _$SearchLibraryResultFromJson(Map<String, dynamic> json) => _SearchLibraryResult(
...
Map<String, dynamic> _$SearchLibraryResultToJson(_SearchLibraryResult instance) => <String, dynamic>{
...
_SearchResultItem _$SearchResultItemFromJson(Map<String, dynamic> json) =>
    _SearchResultItem(name: json['name'] as String, numItems: (json['numItems'] as num?)?.toInt());

Map<String, dynamic> _$SearchResultItemToJson(_SearchResultItem instance) => <String, dynamic>{
  'name': instance.name,
