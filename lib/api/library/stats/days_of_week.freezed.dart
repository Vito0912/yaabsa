...
/// Adds pattern-matching-related methods to [DaysOfWeek].
extension DaysOfWeekPatterns on DaysOfWeek {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DaysOfWeek value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _DaysOfWeek() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DaysOfWeek value)  $default,){
final _that = this;
switch (_that) {
case _DaysOfWeek():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DaysOfWeek value)?  $default,){
final _that = this;
switch (_that) {
case _DaysOfWeek() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "Monday")  double? monday, @JsonKey(name: "Tuesday")  double? tuesday, @JsonKey(name: "Wednesday")  double? wednesday, @JsonKey(name: "Thursday")  double? thursday, @JsonKey(name: "Friday")  double? friday, @JsonKey(name: "Saturday")  double? saturday, @JsonKey(name: "Sunday")  double? sunday)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DaysOfWeek() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "Monday")  double? monday, @JsonKey(name: "Tuesday")  double? tuesday, @JsonKey(name: "Wednesday")  double? wednesday, @JsonKey(name: "Thursday")  double? thursday, @JsonKey(name: "Friday")  double? friday, @JsonKey(name: "Saturday")  double? saturday, @JsonKey(name: "Sunday")  double? sunday)  $default,) {final _that = this;
switch (_that) {
case _DaysOfWeek():
return $default(_that.monday,_that.tuesday,_that.wednesday,_that.thursday,_that.friday,_that.saturday,_that.sunday);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "Monday")  double? monday, @JsonKey(name: "Tuesday")  double? tuesday, @JsonKey(name: "Wednesday")  double? wednesday, @JsonKey(name: "Thursday")  double? thursday, @JsonKey(name: "Friday")  double? friday, @JsonKey(name: "Saturday")  double? saturday, @JsonKey(name: "Sunday")  double? sunday)?  $default,) {final _that = this;
switch (_that) {
case _DaysOfWeek() when $default != null:
return $default(_that.monday,_that.tuesday,_that.wednesday,_that.thursday,_that.friday,_that.saturday,_that.sunday);case _:
  return null;
