...
/// Adds pattern-matching-related methods to [UserListeningStats].
extension UserListeningStatsPatterns on UserListeningStats {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UserListeningStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UserListeningStats() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UserListeningStats value)  $default,){
final _that = this;
switch (_that) {
case _UserListeningStats():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UserListeningStats value)?  $default,){
final _that = this;
switch (_that) {
case _UserListeningStats() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "totalTime")  double? totalTime, @JsonKey(name: "items")  Map<String, ItemsListenedTo>? items, @JsonKey(name: "days")  Map<String, double>? days, @JsonKey(name: "dayOfWeek")  DaysOfWeek? dayOfWeek, @JsonKey(name: "today")  double? today, @JsonKey(name: "recentSessions")  List<PlaybackSession>? recentSessions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserListeningStats() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "totalTime")  double? totalTime, @JsonKey(name: "items")  Map<String, ItemsListenedTo>? items, @JsonKey(name: "days")  Map<String, double>? days, @JsonKey(name: "dayOfWeek")  DaysOfWeek? dayOfWeek, @JsonKey(name: "today")  double? today, @JsonKey(name: "recentSessions")  List<PlaybackSession>? recentSessions)  $default,) {final _that = this;
switch (_that) {
case _UserListeningStats():
return $default(_that.totalTime,_that.items,_that.days,_that.dayOfWeek,_that.today,_that.recentSessions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "totalTime")  double? totalTime, @JsonKey(name: "items")  Map<String, ItemsListenedTo>? items, @JsonKey(name: "days")  Map<String, double>? days, @JsonKey(name: "dayOfWeek")  DaysOfWeek? dayOfWeek, @JsonKey(name: "today")  double? today, @JsonKey(name: "recentSessions")  List<PlaybackSession>? recentSessions)?  $default,) {final _that = this;
switch (_that) {
case _UserListeningStats() when $default != null:
return $default(_that.totalTime,_that.items,_that.days,_that.dayOfWeek,_that.today,_that.recentSessions);case _:
  return null;
