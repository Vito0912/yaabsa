...
_ItemsListenedTo _$ItemsListenedToFromJson(Map<String, dynamic> json) => _ItemsListenedTo(
...
Map<String, dynamic> _$ItemsListenedToToJson(_ItemsListenedTo instance) => <String, dynamic>{
  'id': instance.id,
