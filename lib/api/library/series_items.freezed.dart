...
/// Adds pattern-matching-related methods to [SeriesItems].
extension SeriesItemsPatterns on SeriesItems {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SeriesItems value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SeriesItems() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SeriesItems value)  $default,){
final _that = this;
switch (_that) {
case _SeriesItems():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SeriesItems value)?  $default,){
final _that = this;
switch (_that) {
case _SeriesItems() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "results")  List<Series> results, @JsonKey(name: "total")  int total, @JsonKey(name: "page")  int page, @JsonKey(name: "limit")  int? limit, @JsonKey(name: "sortBy")  String? sortBy, @JsonKey(name: "sortDesc")  bool? sortDesc, @JsonKey(name: "filterBy")  String? filterBy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SeriesItems() when $default != null:
return $default(_that.results,_that.total,_that.page,_that.limit,_that.sortBy,_that.sortDesc,_that.filterBy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "results")  List<Series> results, @JsonKey(name: "total")  int total, @JsonKey(name: "page")  int page, @JsonKey(name: "limit")  int? limit, @JsonKey(name: "sortBy")  String? sortBy, @JsonKey(name: "sortDesc")  bool? sortDesc, @JsonKey(name: "filterBy")  String? filterBy)  $default,) {final _that = this;
switch (_that) {
case _SeriesItems():
return $default(_that.results,_that.total,_that.page,_that.limit,_that.sortBy,_that.sortDesc,_that.filterBy);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "results")  List<Series> results, @JsonKey(name: "total")  int total, @JsonKey(name: "page")  int page, @JsonKey(name: "limit")  int? limit, @JsonKey(name: "sortBy")  String? sortBy, @JsonKey(name: "sortDesc")  bool? sortDesc, @JsonKey(name: "filterBy")  String? filterBy)?  $default,) {final _that = this;
switch (_that) {
case _SeriesItems() when $default != null:
return $default(_that.results,_that.total,_that.page,_that.limit,_that.sortBy,_that.sortDesc,_that.filterBy);case _:
  return null;
...
class _SeriesItems implements SeriesItems {
  const _SeriesItems({@JsonKey(name: "results") required  List<Series> results, @JsonKey(name: "total") required this.total, @JsonKey(name: "page") required this.page, @JsonKey(name: "limit") this.limit, @JsonKey(name: "sortBy") this.sortBy, @JsonKey(name: "sortDesc") this.sortDesc, @JsonKey(name: "filterBy") this.filterBy}): _results = results;
