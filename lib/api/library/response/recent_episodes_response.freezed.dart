...
class _RecentEpisodesResponse implements RecentEpisodesResponse {
  const _RecentEpisodesResponse({@JsonKey(name: 'episodes') final  List<Episode> episodes = const <Episode>[], @JsonKey(name: 'limit', fromJson: jsonIntRequiredFromDynamic) this.limit = 0, @JsonKey(name: 'page', fromJson: jsonIntRequiredFromDynamic) this.page = 0}): _episodes = episodes;
