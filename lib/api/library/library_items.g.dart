...
_LibraryItems _$LibraryItemsFromJson(Map<String, dynamic> json) => _LibraryItems(
  results: (json['results'] as List<dynamic>).map((e) => LibraryItem.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$LibraryItemsToJson(_LibraryItems instance) => <String, dynamic>{
...
const _$MediaTypeEnumMap = {MediaType.BOOK: 'book', MediaType.PODCAST: 'podcast'};
