...
_CollapsedSeries _$CollapsedSeriesFromJson(Map<String, dynamic> json) => _CollapsedSeries(
...
Map<String, dynamic> _$CollapsedSeriesToJson(_CollapsedSeries instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
