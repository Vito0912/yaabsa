...
_PlaylistItem _$PlaylistItemFromJson(Map<String, dynamic> json) => _PlaylistItem(
...
Map<String, dynamic> _$PlaylistItemToJson(_PlaylistItem instance) => <String, dynamic>{
