...
class WearAudioHandler extends BaseAudioHandler {
  ...
  Future<void> loadMedia({required List<MediaItem> mediaItems, required List<AudioSource> audioSources, Duration initialPosition = Duration.zero}) async {
  ...
  @override Future<void> skipToPrevious() async { _player.hasPrevious ? await _player.seekToPrevious() : await _player.seek(Duration.zero); }
