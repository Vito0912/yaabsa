...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime timestamp,  String message,  InfoLevel level,  String? tag)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LogEntry() when $default != null:
return $default(_that.timestamp,_that.message,_that.level,_that.tag);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime timestamp,  String message,  InfoLevel level,  String? tag)  $default,) {final _that = this;
switch (_that) {
case _LogEntry():
return $default(_that.timestamp,_that.message,_that.level,_that.tag);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime timestamp,  String message,  InfoLevel level,  String? tag)?  $default,) {final _that = this;
switch (_that) {
case _LogEntry() when $default != null:
return $default(_that.timestamp,_that.message,_that.level,_that.tag);case _:
  return null;
