...
_InternalAnnotation _$InternalAnnotationFromJson(Map<String, dynamic> json) => _InternalAnnotation(
...
Map<String, dynamic> _$InternalAnnotationToJson(_InternalAnnotation instance) => <String, dynamic>{
  'cfi': instance.cfi,
  'text': instance.text,
