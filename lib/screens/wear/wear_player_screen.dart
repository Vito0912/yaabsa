...
class _WearPlayerScreenState extends ConsumerState<WearPlayerScreen> {
  String? _title, _author, _coverUrl, _error;
  bool _isPlaying = false, _isLoading = true;
  double _volume = 0.7;
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (creds == null) return setState(() { _error = 'Not connected to server'; _isLoading = false; });
      final api = ABSApi(
      ...
      setState(() { _title = title; _author = author; _coverUrl = cover; _isPlaying = false; _isLoading = false; });
    ...
    return Stack(fit: StackFit.expand, children: [
      ...
      Column(children: [
        ...
        Padding(
          ...
          child: IconButton(icon: const Icon(Icons.volume_up, color: Colors.white54, size: 24), onPressed: _vol),
        ),
      ]),
    ]);
  }
